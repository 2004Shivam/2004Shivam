...
const brain = {
  thinking_about: [
    ...
    "interaction as the documentation",
    "small behaviors with outsized delight",
  ],
  building_with: ["curiosity", "prototypes", "too many tabs open"],
  not_building_with: ["feature lists", "premature abstraction"],
}
```
